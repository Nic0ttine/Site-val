...
filter.lfs.smudge=git-lfs smudge -- %f
user.name=nicolas
user.email=nicolas.lejeanvre@gmail.com
...
remote.origin.url=https://github.com/Nic0ttine/Site-val.git
diff.astextplain.textconv=astextplain
filter.lfs.clean=git-lfs clean -- %f
filter.lfs.smudge=git-lfs smudge -- %f
filter.lfs.process=git-lfs filter-process
...
branch.feature/add-colors.vscode-merge-base=origin/main
diff.astextplain.textconv=astextplain
filter.lfs.clean=git-lfs clean -- %f
filter.lfs.smudge=git-lfs smudge -- %f
filter.lfs.process=git-lfs filter-process
...
335a244 (origin/feature/add-colors, feature/add-colors) changements colorimétriques
c866533 changement texte tout en haut
